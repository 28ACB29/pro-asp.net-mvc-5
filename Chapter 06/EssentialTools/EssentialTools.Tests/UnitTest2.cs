...
namespace EssentialTools.Tests
{
	...
	public class UnitTest2
	{
		...
		public void Pass_Through_Variable_Discounts()
		{
			...
			// act
			decimal FiveDollarDiscount = target.ValueProducts(this.createProduct(5));
			decimal TenDollarDiscount = target.ValueProducts(this.createProduct(10));
			decimal FiftyDollarDiscount = target.ValueProducts(this.createProduct(50));
			decimal HundredDollarDiscount = target.ValueProducts(this.createProduct(100));
			decimal FiveHundredDollarDiscount = target.ValueProducts(this.createProduct(500));
			...
			target.ValueProducts(this.createProduct(0));
		}
	}
}
